...
class ListViewPageDevOnBoarding extends StatefulWidget {
  @override
...
class _ListViewPageDevAcceptedState extends State<ListViewPageDevOnBoarding> {
  ...
  Widget buildViewPage() {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Requests are onboarding'),
        actions: <Widget>[
          IconButton(
              onPressed: () async {
